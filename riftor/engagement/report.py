...
def report_data(engagement) -> dict:
    ...
    return {
        ...
        "methodology_done": done,
        "methodology_total": total,
...
def build_markdown(data: dict) -> str:
    ...
    out.append("")
    out.append(
        f"_Generated {data['generated']} · checklist: "
        f"{data.get('methodology_done', 0)}/{data.get('methodology_total', 0)}_"
    )
    out.append("")
    ...
    out.append("---")
    out.append("_OWASP/PTES methodology · generated by riftor_")
    return "\n".join(out) + "\n"
...
def build_html(data: dict) -> str:
    ...
    parts.append(
        f"<p class=muted>Generated {esc(data['generated'])} · checklist: "
        f"{data.get('methodology_done', 0)}/{data.get('methodology_total', 0)}</p>"
    )
    ...
    parts.append("<hr><p class=muted>OWASP/PTES methodology · generated by riftor</p>")
...
def build_json(data: dict) -> str:
    ...
    payload = {
        ...
        "methodology_done": data.get("methodology_done", 0),
        "methodology_total": data.get("methodology_total", 0),
