...
_riftor() {
    ...
    opts="--version --config --model --worker-model --chakla-model --api-key --workdir --scope-file --browser-headed --prompt --headless --help"
    ...
    case "$prev" in
        --workdir|--scope-file)
            ...
            return 0
            ;;
        --model|--worker-model|--chakla-model)
            # worker_model defaults to "" (reuse main); Haiku is a common cheap override
